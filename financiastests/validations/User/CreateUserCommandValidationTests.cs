...
namespace financiastests.validations.User
{
    public class CreateUserCommandValidationTests
    {
        ...
        [Fact]
        public void CreateUserCommandValidation_ObjectWithNameFieldGreaterThanThirty_ReturnValidFalse()
        {
            var createUserCommand = _fixture.Create<CreateUserCommand>();
        ...
        [Fact]
        public void CreateUserCommandValidation_ObjectWithNameFieldNull_ReturnValidFalse()
        {
            var createUserCommand = _fixture.Create<CreateUserCommand>();
        ...
        [Fact]
        public void CreateUserCommandValidation_ObjectWithNameFielEmpty_ReturnValidFalse()
        {
            var createUserCommand = _fixture.Create<CreateUserCommand>();
        ...
        [Fact]
        public void CreateUserCommandValidation_ObjectWithPassawordFieldLessThanFour_ReturnValidFalse()
        {
            var createUserCommand = _fixture.Create<CreateUserCommand>();
        ...
        [Fact]
        public void CreateUserCommandValidation_ObjectWithPassawordFieldGreaterThanThirty_ReturnValidFalse()
        {
            var createUserCommand = _fixture.Create<CreateUserCommand>();
            createUserCommand.Name = "Teste";
            createUserCommand.Email = "teste123@hotmail.com";
        ...
        [Fact]
        public void CreateUserCommandValidation_ObjectWithEmailFieldInvalid_ReturnValidFalse()
        {
            var createUserCommand = _fixture.Create<CreateUserCommand>();
            createUserCommand.Name = "Teste";
        ...
        [Fact]
        public void CreateUserCommandValidation_ObjectWithEmailFieldNull_ReturnValidFalse()
        {
            var createUserCommand = _fixture.Create<CreateUserCommand>();
            createUserCommand.Name = "Teste";
