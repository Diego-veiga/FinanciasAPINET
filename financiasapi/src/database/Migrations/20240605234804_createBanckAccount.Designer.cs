...
namespace financias.database.Migrations
{
    ...
    [Migration("20240605234804_createBanckAccount")]
    partial class createBanckAccount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("financias.src.models.Banck", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = true,
                            Cnpj = "60701190000104",
                            CreatedAt = new DateTime(2024, 6, 5, 20, 48, 4, 545, DateTimeKind.Local).AddTicks(355),
                            Name = "Itau",
                        ...
                        new
                        {
                            ...
                            Active = true,
                            Cnpj = "60746948000112",
                            CreatedAt = new DateTime(2024, 6, 5, 20, 48, 4, 545, DateTimeKind.Local).AddTicks(368),
                            Name = "Bradesco",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            Active = true,
                            Cnpj = "90400888000142",
                            CreatedAt = new DateTime(2024, 6, 5, 20, 48, 4, 545, DateTimeKind.Local).AddTicks(369),
                            Name = "Santander",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("financias.src.models.UserBancksAccounts", b =>
                {
                    b.HasOne("financias.src.models.BanckAccount", null)
